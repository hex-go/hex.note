...
id: "930595fe33f3cc7b"
title: "10. 泛型 | 秀才的进阶之路"
url: "https://golangstar.cn/go_series/go_advanced/generics.html?by=history&from=kkframenew#_1-%E4%BB%80%E4%B9%88%E6%98%AF%E6%B3%9B%E5%9E%8B"
favicon: "https://golangstar.cn/favicon.ico"
tags: ["Go语言", "golang", "go进阶", "泛型"]
folder: "Go"
createdAt: "2026-05-06T03:47:15.720Z"
updatedAt: "2026-05-06T03:48:22.034Z"
contentType: "markdown"
version: 1
byline: "秀才"
siteName: "秀才的进阶之路"
publishedTime: "2026-05-06T03:47:15.718Z"
---
...
#### [**3.1.1 类型形参和类型实参**](#_3-1-1-类型形参和类型实参)

函数在使用上需要在函数定义时指定形参，函数调用时需要传入实参。

![类型形参和类型实参](https://raw.githubusercontent.com/hex-go/hex.note/main/notedown/assets/9/930595fe33f3cc7b/38994d538238747f7c8aa311366d0b803b2025aa.png)

类型形参和类型实参

在引入范型后，Go语言的函数和类型现在可以包含类型参数。类型参数列表的语法类似于普通参数列表，但使用方括号（`[]`）而不是圆括号（`()`）。

![类型参数](https://raw.githubusercontent.com/hex-go/hex.note/main/notedown/assets/9/930595fe33f3cc7b/4636e12eaa34a504e123dbfe86e1d5224d92db47.png)
...
![类型集](https://raw.githubusercontent.com/hex-go/hex.note/main/notedown/assets/9/930595fe33f3cc7b/58486d050099144741d864defafed585c778a1b3.png)
...
![类型集](https://raw.githubusercontent.com/hex-go/hex.note/main/notedown/assets/9/930595fe33f3cc7b/dc26839543fa2c6a844f6428cbbf9eff701d03eb.png)
...
#### [**3.3.1 函数参数类型推断**](#_3-3-1-函数参数类型推断)
...
#### [**3.3.2 约束类型推断**](#_3-3-2-约束类型推断)

Go 语言还提供了一种称为\_约束类型推断\_的机制。为了更好地理解这个概念，让我们通过一个处理整数缩放的示例来说明：
...
![](https://raw.githubusercontent.com/hex-go/hex.note/main/notedown/assets/9/930595fe33f3cc7b/d554a1c20909af04a7f51331e06bbf7c498047ce.png)
